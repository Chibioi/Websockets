...
class WebsocketFrame:
    ...
    def populateFromWebsocketFrameMessage(self, data_in_bytes):
        self.parse_flags(data_in_bytes)
        self.parse_payload_length(data_in_bytes)
        self.maybe_parse_masking_key(data_in_bytes)
        self.parse_payload(data_in_bytes)

    def parse_flags(self, data_in_bytes):
    ...
    def parse_payload_length(self, data_in_bytes):
    ...
    def maybe_parse_masking_key(self, data_in_bytes):
        if not self._mask:
            return
    ...
    def parse_payload(self, data_in_bytes):
